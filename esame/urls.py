...
urlpatterns = [
    ...
    path('search', views.cerca_profilo, name='cerca_profilo'),
    path("error", views.ErroreRicerca.as_view(),name='errore_ricerca'),
    path("battutes/<int:pk>", views.BattuteProfilo.as_view(),name='battute_profilo')
